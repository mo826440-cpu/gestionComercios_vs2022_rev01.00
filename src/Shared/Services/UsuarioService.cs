...
public class UsuarioService : IUsuarioService
{
    ...
    public async Task<Usuario> UpdateAsync(Usuario usuario)
    {
        ...
        var response = await _supabaseService.Client
            ...
            .Set(x => x.Nombre, usuario.Nombre ?? (string?)null)
            .Set(x => x.NombreUsuario, usuario.NombreUsuario ?? (string?)null)
            .Set(x => x.Contacto, usuario.Contacto ?? (string?)null)
            .Set(x => x.Referencias, usuario.Referencias ?? (string?)null)
            .Set(x => x.IdPublico, usuario.IdPublico ?? (string?)null)

-- ============================================
-- Script para Limpiar Datos de Testing
-- ============================================
-- IMPORTANTE: Este script elimina TODOS los datos de las tablas principales
-- Solo usar en entorno de desarrollo/testing
-- ============================================
-- NOTA: Usa DELETE FROM (no "ELIMINAR DE") - SQL estándar en inglés
-- ============================================

-- Paso 1: Eliminar detalles primero (para evitar errores de FK)
...
DELETE FROM ventas;
DELETE FROM compras;
DELETE FROM stock;  -- Nota: La tabla se llama "stock", no "existencias"
...
-- Paso 3: Eliminar usuarios y comercios
-- Nota: Esto también eliminará las relaciones en otras tablas
